...
//   @override
//   State<FMap> createState() => _MapState();
// }

// class _MapState extends State<FMap> {
//   updateInfo() {
//     _shapeSource = MapShapeSource.asset(
//       'assets/world.geojson',
//       shapeDataField: "ISO_A2",
//       dataCount: _mapData.length,
//       primaryValueMapper: (int index) => _mapData[index].code,
...
//                           child: FittedBox(
//                             child: CountryWidget(Country(_mapData[index].name,
//                                 _mapData[index].code.toLowerCase())),
//                           )),
...
//                       print(index);
//                       selectedIndex = index;
//                       if (_mapData[index].Chosen != true) {
//                         _mapData[index].Chosen = true;
//                         _mapData[index].color = Colors.amber;
//                         print(_mapData[index].Chosen.toString());
//                         updateInfo();
//                       }
//                     });
//                   },
...
// //   Model(this.State, this.color, this.StateCode, this.Chosen);
// // }
