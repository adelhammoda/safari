    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: LocalizationCubit.get(context).localization ? EdgeInsets.only(right: 20) : EdgeInsets.only(right: 260),
            child: Align(
              alignment: LocalizationCubit.get(context).localization ? Alignment.topRight : Alignment.topLeft,
              child: Text(
                S.of(context).pageFacilities,style: Theme.of(context).textTheme.subtitle1,),
            ),
          ),
          SizedBox(height: 9,),
          SingleChildScrollView(
